...
pipelines_files = {
    ...
    "itCCA-SSVEP": "itCCA-SSVEP.yml",
    "eCCA-SSVEP": "eCCA-SSVEP.yml",
    "TRCA-R-SSVEP": "TRCA_R-SSVEP.yml",
    "SSCOR-SSVEP": "SSCOR-SSVEP.yml",
    "TDCA-SSVEP": "TDCA-SSVEP.yml",
    "MsetCCA-SSVEP": "MsetCCA-SSVEP.yml",
    "SSVEP CCA": "CCA-SSVEP.yml",
