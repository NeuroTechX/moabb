...
Additionally, a visual overview of all datasets can be generated using the function :func:`moabb.datasets.utils.plot_all_datasets`. 
...
.. figure:: ../_static/datasets_overview.png
