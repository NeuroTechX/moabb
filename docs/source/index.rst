...
.. meta::
   :description: MOABB (Mother of all BCI Benchmarks) - Open-source Python framework for reproducible EEG-based brain-computer interface benchmarking with 67+ datasets, standardized evaluations, and built on MNE-Python and scikit-learn.
