...
- Add 4 new motor-imagery dataset adapters: :class:`moabb.datasets.Han2026` (35 subjects, binary basketball motor-observation vs motor-imagery of dribbling, 64-channel at 1000 Hz, OpenNeuro ``ds007327``), :class:`moabb.datasets.Batista2022` (20 subjects, binary motor-imagery BCI training with virtual reality and haptic feedback, 32-channel at 500 Hz), :class:`moabb.datasets.Zhao2026` (single subject, 3-class grip-force-level motor imagery, 60-channel at 1000 Hz), and :class:`moabb.datasets.InEarMI2026` (26 subjects, binary left- vs right-hand motor imagery from a 7-channel in-ear EEG montage at 500 Hz) (by `Bruno Aristimunha`_)
- Add 4 new motor-imagery dataset adapters: :class:`moabb.datasets.Pan2023` (14 subjects, binary cross-session left/right-hand motor imagery across two sessions, 28-channel at 250 Hz), :class:`moabb.datasets.PardoGarcia2026` (18 chronic-stroke patients, binary hand motor imagery — precision pinch vs closed fist — probing mu/beta oscillatory changes after rehabilitation, 63-channel at 1000 Hz), :class:`moabb.datasets.Kodera2023` (29 subjects, binary left/right-hand motor imagery, 16-channel at 500 Hz), and :class:`moabb.datasets.Sun2026` (14 subjects, 4-class cross-environment multi-paradigm motor imagery, 64-channel at 1000 Hz, OpenNeuro ``ds007221``) (by `Bruno Aristimunha`_)
