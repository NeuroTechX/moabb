...
- Evaluations now combine evaluation defaults with ``cv_kwargs`` before splitter construction. Caller settings override defaults, and splitter construction passes each setting 1 time (:gh:`1110` by `stanbot8`_).
...
.. _stanbot8: https://github.com/stanbot8
