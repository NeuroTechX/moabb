...
- Add 4 new motor-imagery dataset adapters: :class:`moabb.datasets.Pan2023` (14 subjects, binary cross-session left/right-hand motor imagery across two sessions, 28-channel at 250 Hz), :class:`moabb.datasets.PardoGarcia2026` (18 chronic-stroke patients, binary hand motor imagery — precision pinch vs closed fist — probing mu/beta oscillatory changes after rehabilitation, 63-channel at 1000 Hz), :class:`moabb.datasets.Kodera2023` (29 subjects, binary left/right-hand motor imagery, 9-channel normalized from 9/16-channel source recordings at 500/1000 Hz), and :class:`moabb.datasets.Sun2026` (14 subjects, 4-class cross-environment multi-paradigm motor imagery, 64-channel at 1000 Hz, OpenNeuro ``ds007221``) (by `Bruno Aristimunha`_)
