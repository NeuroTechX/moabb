...
- Rename event to `subtraction` in :func:`moabb.datasets.Shin2017B` (:gh:`397` by `Pierre Guetschel`_)
...
- Fix the cropped option in the dataset preprocessing (:gh:`` by `Bruno Aristimunha`_)
