...
within the :class:`moabb.datasets.Cattan2019`  dataset.
...
from moabb.datasets import Cattan2019
...
# 2) Create an instance of the :class:`moabb.datasets.Cattan2019` dataset.
