...
import moabb
from moabb.datasets import Exoskeleton_SSVEP
...
# use the dataset Exoskeleton_SSVEP. All 3 SSVEP paradigms applied a bandpass filter (10-42 Hz) on
