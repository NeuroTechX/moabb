...
with open(
    "./Results/Models_WithinSession/BNCI2014-001/1/1E/GridSearchEN/fitted_model_best.pkl",
    "rb",
) as pickle_file:
...
with open(
    "./Results/Models_WithinSession/BNCI2014-001/1/0T/GridSearchEN/fitted_model_best.pkl",
    "rb",
) as pickle_file:
