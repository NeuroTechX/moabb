...
from keras.layers import GRU, LSTM, MaxPooling1D, Input, DepthwiseConv2D, AvgPool2D, SeparableConv2D, LayerNormalization, Lambda, DepthwiseConv2D, Concatenate, Add
...
def EEGNet(self, input_layer, F1=8, kernLength=64, D=2, dropout=0.5, activation="elu"):
    ...
    block1 = Conv2D(F1, kernel_size=(1, kernLength), padding='same',
                    input_shape=(self.X_shape_[1], self.X_shape_[2], 1),
                    use_bias=False)(input_layer)
    block1 = BatchNormalization()(block1)
    block1 = DepthwiseConv2D(kernel_size=(self.X_shape_[1], 1), use_bias=False,
                             depth_multiplier=2,
    ...
    block2 = SeparableConv2D(F2, kernel_size=(1, 16),
