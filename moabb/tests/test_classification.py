...
class TestSSVEP_itCCA:
    ...
    def test_fit(self):
        ...
        assert hasattr(self.clf, "le_")
        assert hasattr(self.clf, "one_hot_")
        assert hasattr(self.clf, "templates_")
    ...
    def test_fit_predict_is_fitted(self):
        ...
        self.clf.fit(self.X, self.y)
        check_is_fitted(
            self.clf, attributes=["classes_", "one_hot_", "templates_", "freqs_", "le_"]
        )


class TestSSVEP_eCCA:
    def setup_method(self):
        dataset = FakeDataset(
            n_sessions=1,
            n_runs=1,
        ...
        self.X = X
        self.y = y
        self.clf = SSVEP_eCCA(n_harmonics=3)
    ...
    def test_fit(self):
        ...
        assert hasattr(self.clf, "le_")
        assert hasattr(self.clf, "one_hot_")
        assert hasattr(self.clf, "slen_")
        assert hasattr(self.clf, "templates_")
        assert hasattr(self.clf, "Yf")
        assert hasattr(self.clf, "w_template_")
