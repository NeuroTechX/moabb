...
class Kim2025BetaRange(BaseDataset):
    ...
    METADATA = DatasetMetadata(
        ...
        data_structure=DataStructureMetadata(n_blocks=6, n_trials=240),
        signal_processing=SignalProcessingMetadata(
            classifiers=["CCA", "FBCCA", "ITCCA", "TRCA", "EEGNet"],
            feature_extraction=["CCA", "FBCCA", "TRCA"],
            frequency_bands={"stimulus_range": [14.0, 22.0], "analysis": [13.0, 89.0]},
        ...
        bci_application=BCIApplicationMetadata(
            environment="lab", online_feedback=None, applications=["speller"]
        ),
