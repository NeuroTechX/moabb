    ...
    **2-stream condition:**
    ...
    METADATA = DatasetMetadata(
        ...
        preprocessing=PreprocessingMetadata(
            ...
            preprocessing_steps=[
                "highpass filter 1.0 Hz (2nd order Butterworth)",
                "PCA (15 components)",
                "ICA with FastICA for EOG artifact removal",
                "bandpass filter 1-40 Hz (2nd order Butterworth, zero-phase) for ERP analysis",
                "bandpass filter 0.1-8 Hz (2nd order Butterworth, zero-phase) for classification",
            ...
            notes="EOG artifact removal using ICA on 15 PCs selected via PCA. Different bandpass filters applied for ERP analysis (1-40 Hz) vs classification (0.1-8 Hz)",
        ),
        ...
        cross_validation=CrossValidationMetadata(
            cv_method="4-fold chronological cross-validation",
            cv_folds=4,
