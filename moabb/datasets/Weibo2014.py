...
class Weibo2014(BaseDataset):
    ...
    METADATA = DatasetMetadata(
        ...
        documentation=DocumentationMetadata(
            ...
            country="China",
            data_url="http://dx.doi.org/10.7910/DVN/27306",
            publication_year=2014,
            senior_author="Dong Ming",
            contact_info=["qhz@tju.edu.cn", "richardming@tju.edu.cn"],
            funding=[
                "National Natural Science Foundation of China (No. 81222021, 61172008, 81171423, 51377120, 31271062)",
                "National Key Technology R&D Program of the Ministry of Science and Technology of China (No. 2012BAI34B02)",
                "Program for New Century Excellent Talents in University of the Ministry of Education of China (No. NCET-10-0618)",
                "Natural Science Foundation of Tianjin (No. 13JCQNJC13900)",
            ],
            ethics_approval=["Ethical committee of Tianjin University"],
            keywords=[
                "motor imagery",
                "compound limb motor imagery",
                "EEG oscillatory patterns",
                "cognitive process",
        ...
        preprocessing=PreprocessingMetadata(
            ...
            preprocessing_steps=["bandpass filtering", "downsampling", "ICA"],
            highpass_hz=0.5,
            lowpass_hz=50.0,
        ...
        signal_processing=SignalProcessingMetadata(
            ...
            spatial_filters=["CCD", "Source Localization"],
        ),
        cross_validation=CrossValidationMetadata(
            cv_method="bootstrap",
        ),
        bci_application=BCIApplicationMetadata(
            applications=["vr_ar", "communication", "rehabilitation"],
        ...
        data_structure=DataStructureMetadata(
            n_trials=560,
            trials_context="8 sections with 60 trials each (10 trials per MI task per section) for 6 MI tasks, plus 1 section with 80 trials for rest state",
        ),
        data_processed=True,
        file_format="EEG",
    )
