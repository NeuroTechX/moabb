    ...
    **Dataset Description**
    ...
    METADATA = DatasetMetadata(
        ...
        participants=ParticipantMetadata(
            ...
            age_min=30,
            age_max=56,
            ages=[56, 51, 47, 33, 43, 30, 30, 30, 30],
            clinical_population="5 disabled (cerebral palsy, multiple sclerosis, ALS, traumatic brain injury, post-anoxic encephalopathy), 4 able-bodied",
        ...
        preprocessing=PreprocessingMetadata(
            ...
            notes="10th and 90th percentile windsorizing applied to reduce outliers from eye blinks, eye movement, muscle activity",
        ),
