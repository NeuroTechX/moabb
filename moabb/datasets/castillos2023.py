...
class CastillosBurstVEP100(BaseCastillos2023):
    ...
    .. admonition:: Dataset summary
        ...
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== =============== =================
        Name                 #Subj   #Sessions Sampling rate #Chan Trials length #Trial classes #Trials / class #Epoch classes #Epochs / class Presentation rate
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== =============== =================
        CastillosBurstVEP100  12        1          500Hz      32        2.2s            4        15/15/15/15       2            5820NT/1200T                60Hz
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== =============== =================
...
class CastillosBurstVEP40(BaseCastillos2023):
    ...
    .. admonition:: Dataset summary
        ...
        Name                 #Subj   #Sessions Sampling rate #Chan Trials length #Trial classes #Trials / class #Epoch classes #Epochs / class Presentation rate
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== =============== =================
        CastillosBurstVEP40   12        1          500Hz      32        2.2s            4        15/15/15/15       2            5820NT/1200T               60Hz
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== =============== =================
...
class CastillosCVEP100(BaseCastillos2023):
    ...
    .. admonition:: Dataset summary
        ...
        Name                 #Subj   #Sessions Sampling rate #Chan Trials length #Trial classes #Trials / class #Epoch classes #Epochs / class Presentation rate
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== =============== =================
        CastillosCVEP100      12        1          500Hz      32        2.2s            4        15/15/15/15       2            3525NT/3495T              60Hz
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== =============== =================
...
class CastillosCVEP40(BaseCastillos2023):
    ...
    .. admonition:: Dataset summary
        ...
        Name                 #Subj   #Sessions Sampling rate #Chan Trials length #Trial classes #Trials / class #Epoch classes #Epochs / class Presentation rate
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== =============== =================
        CastillosCVEP40       12        1          500Hz      32        2.2s            4        15/15/15/15       2            3525NT/3495T             60Hz
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== =============== =================
