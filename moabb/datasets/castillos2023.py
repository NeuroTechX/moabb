...
class CastillosBurstVEP100(BaseCastillos2023):
    ...
    .. admonition:: Dataset summary
        ...
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== ===============
        CastillosBurstVEP100  12        1          500Hz      32        2.2s            4        15/15/15/15       2            5820NT/1200T
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== ===============
...
class CastillosBurstVEP40(BaseCastillos2023):
    ...
    .. admonition:: Dataset summary
        ...
        Name                 #Subj   #Sessions Sampling rate #Chan Trials length #Trial classes #Trials / class #Epoch classes #Epochs / class
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== ===============
        CastillosBurstVEP40   12        1          500Hz      32        2.2s            4        15/15/15/15       2            5820NT/1200T
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== ===============
...
class CastillosCVEP100(BaseCastillos2023):
    ...
    .. admonition:: Dataset summary
        ...
        Name                 #Subj   #Sessions Sampling rate #Chan Trials length #Trial classes #Trials / class #Epoch classes #Epochs / class
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== ===============
        CastillosCVEP100      12        1          500Hz      32        2.2s            4        15/15/15/15       2            3525NT/3495T
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== ===============
...
class CastillosCVEP40(BaseCastillos2023):
    ...
    .. admonition:: Dataset summary
        ...
        Name                 #Subj   #Sessions Sampling rate #Chan Trials length #Trial classes #Trials / class #Epoch classes #Epochs / class
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== ===============
        CastillosCVEP40       12        1          500Hz      32        2.2s            4        15/15/15/15       2            3525NT/3495T
        ==================== ======= ========= ============= ===== ============= ============== =============== ============== ===============
