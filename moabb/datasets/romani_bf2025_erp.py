...
class RomaniBF2025ERP(BaseDataset):
    ...
    METADATA = DatasetMetadata(
        acquisition=AcquisitionMetadata(
            ...
            reference="mastoid",
            ground="mastoid",
            software="Unity 2022.3 with Unicorn SDK",
        ...
        experiment=ExperimentMetadata(
            ...
            trial_duration=0.9,
            study_design="within-subject study with multiple runs, two task complexities (Complex Task with 5 targets, Speller Task with 10 targets), counterbalanced visual texture conditions (checkerboard vs grain-like), and post-session questionnaires",
        ...
        preprocessing=PreprocessingMetadata(
            ...
            filter_type="built-in preprocessing pipeline",
            artifact_methods=[
                "motion artifact minimization through participant instruction"
            ],
            epoch_window=[0.0, 0.9],
            notes="Data stream automatically filtered through pipeline and segmented between event onset and 900ms after the event",
        ),
        ...
        bci_application=BCIApplicationMetadata(
            applications=["speller", "gaming", "communication", "BCI training"],
        ...
        data_structure=DataStructureMetadata(
            n_trials=60,
            trials_context="calibration (60 trials per calibration session, ~1 minute)",
            n_blocks=None,
        ...
        cross_validation=CrossValidationMetadata(
            ...
            cv_folds=None,
            evaluation_type=["within-subject", "online"],
        ),
        performance={
