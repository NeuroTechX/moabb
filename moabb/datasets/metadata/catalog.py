...
BNCI2024_001_METADATA = DatasetMetadata(
    ...
    documentation=DocumentationMetadata(
        ...
        investigators=["L. Duan", "H. Zhong", "J. Miao", "Z. Yang", "W. Ma", "X. Zhang"],
...
BNCI2015_006_METADATA = DatasetMetadata(
    ...
    experiment=ExperimentMetadata(
        ...
        events={"Target": 1, "NonTarget": 2},  # Match class definition
        n_classes=2,
        trial_duration=1.0,
    ),
    documentation=DocumentationMetadata(
...
BNCI2015_012_METADATA = DatasetMetadata(
    ...
    documentation=DocumentationMetadata(
        ...
        investigators=["Farwell, L.A.", "Donchin, E."],
        institution="Technische Universität Berlin",
        country="Germany",
        repository="BNCI Horizon 2020",
...
BNCI2020_002_METADATA = DatasetMetadata(
    ...
    documentation=DocumentationMetadata(
        ...
        investigators=["Nagel, S.", "Spüler, M."],
...
EPFLP300_METADATA = DatasetMetadata(
    ...
    documentation=DocumentationMetadata(
        doi="10.1088/1741-2560/8/2/025016",
...
HINSS2021_METADATA = DatasetMetadata(
    ...
    experiment=ExperimentMetadata(
        paradigm="rstate",
        task_type="cognitive_workload",
        events={"resting_state": 1, "easy": 2, "medium": 3, "difficult": 4},
        n_classes=4,
        trial_duration=2.0,
    ),
    documentation=DocumentationMetadata(
