    ...
    **Dataset description**
    ...
    METADATA = DatasetMetadata(
        ...
        documentation=DocumentationMetadata(
            ...
            description="Online optimization of stimulation speed (SOA) in an auditory brain-computer interface using Bayesian optimization and random search. The study evaluated approaches to find individually optimal stimulus onset asynchrony parameters that maximize classification performance.",
            investigators=[
                "Jan Sosulski",
                "David Hübner",
                "Aaron Klein",
