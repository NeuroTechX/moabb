    ...
    **Dataset description**
    ...
    METADATA = DatasetMetadata(
        acquisition=AcquisitionMetadata(
            ...
            electrode_type="sintered Ag/AgCl active electrodes",
            reference="Car",
            sensors=[
                "Fp1",
                "Fpz",
        ...
        performance=PerformanceMetadata(
            ...
            itr_bits_per_min=48.0,
            other_metrics={"symbols_per_minute": 9.0},
        ),
        ...
        paradigm_specific=ParadigmSpecificMetadata(
            ...
            code_type="Gold codes",
            code_length=126,
            n_targets=36,
            stimulus_frequencies_hz=[120.0],
        ),
        data_structure=DataStructureMetadata(
            n_trials=36,
            trials_context="per session (online experiment)",
        ),
