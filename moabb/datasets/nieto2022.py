...
_SFREQ = 1024.0
_EVENTS = {
    "pronounced/up": 2131, "pronounced/down": 2132, "pronounced/right": 2133, "pronounced/left": 2134,
    "inner/up": 2231, "inner/down": 2232, "inner/right": 2233, "inner/left": 2234,
    "visualized/up": 2331, "visualized/down": 2332, "visualized/right": 2333, "visualized/left": 2334
}
...
class Nieto2022(BaseDataset):
    ...
    METADATA = DatasetMetadata(
        ...
        experiment=ExperimentMetadata(
            ...
            mode="offline",
            hed_tags={k: _speech_hed(k.split('/')[-1], k.split('/')[0]) for k in _EVENTS.keys()},
        ),
        documentation=DocumentationMetadata(
            doi=_DOI,
            investigators=["Nicolas Nieto", "Victoria Peterson", "Hugo Leonardo Rufiner", "Diego Milone", "Enzo Ferrante"],
    ...
    def data_path(self, subject, session=None, path=None, force_update=False, update_path=None, verbose=None):
