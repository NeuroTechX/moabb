    ...
    **ID of the dataset**
    ...
    METADATA = DatasetMetadata(
        ...
        experiment=ExperimentMetadata(
            ...
            stimulus_type="visual marker (purple marker on smartphone screen)",
        ...
        preprocessing=PreprocessingMetadata(
            ...
            artifact_methods=["visual fixation to minimize eye movement"],
            notes="Data were acquired with no digital filter. No Faraday cage used to mimic real-world usage.",
        ),
        bci_application=BCIApplicationMetadata(
            applications=["vr_ar"],
            environment="laboratory (real-world conditions, no Faraday cage)",
