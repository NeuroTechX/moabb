    ...
    **Dataset Description**
    ...
    METADATA = DatasetMetadata(
        acquisition=AcquisitionMetadata(
            ...
            sensors=["EEG positions most densely distributed over sensorimotor areas"],
            line_freq=50.0,
    ...
    **Dataset Description**
    ...
    METADATA = DatasetMetadata(
        ...
        documentation=DocumentationMetadata(
            ...
            contact_info=None,
            associated_paper_doi="10.3389/fnins.2012.00055",
            funding=None,
            readme=None,
        ...
        external_links=ExternalLinks(
            source_url="http://biosig.sourceforge.net/",
            ftp_url=None,
