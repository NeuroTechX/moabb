    ...
    **Classification Results (from original paper)**
    ...
    METADATA = DatasetMetadata(
        acquisition=AcquisitionMetadata(
            ...
            sensor_type="Gel-based active electrodes",
            reference="right earlobe",
            ground="AFz",
            software=None,
            filters="8th order Chebyshev filter from 0.01 to 100 Hz, 50 Hz notch",
            sensors=[
                "Fp1",
                "Fpz",
                "Fp2",
        ...
        experiment=ExperimentMetadata(
            paradigm="imagery",
            task_type="reach-and-grasp",
            events={"palmar_grasp": 1, "lateral_grasp": 2, "rest": 3},
            n_classes=2,
            class_labels=["palmar_grasp", "lateral_grasp"],
            trials_per_class={"palmar_grasp": 80, "lateral_grasp": 80},
            trial_duration=None,
            tasks=[
                "reach-and-grasp toward jar (palmar grasp)",
                "reach-and-grasp toward spoon (lateral grasp)",
            ],
            study_design="self-initiated reach-and-grasp actions",
            study_domain="natural movement",
            feedback_type="visual (screen showing number of completed grasps)",
            stimulus_type="physical objects (jar, spoon)",
            stimulus_modalities=["visual"],
            primary_modality="visual",
            synchronicity="self-paced",
            mode="execution",
            has_training_test_split=True,
            instructions="Participants were instructed to focus their gaze on the designated object for 2 s before initiating the reach-and-grasp action. Once they completed the grasp, they held the object for at least 1–2 s. When they returned their hand to the starting position, a small insert on a screen showed them the number of grasps they had already performed on the designated object. Participants paused at least for 4 s before starting a new trial (inter trial interval).",
            cog_atlas_id=None,
            cog_po_id=None,
        ...
        documentation=DocumentationMetadata(
            ...
            associated_paper_doi="10.3389/fnins.2020.00849",
            funding=["Horizon 2020 Project MoreGrasp"],
            readme=None,
            institution_address="Graz, Austria",
            institution_department="Institute of Neural Engineering",
            ethics_approval=["Medical University of Graz (EK: 30-439 ex 17/18)"],
        ...
        preprocessing=PreprocessingMetadata(
            ...
            preprocessing_steps=[
                ...
                "extended infomax ICA for eye artifact removal",
            ...
            re_reference="CAR",
            downsampled_to_hz=16.0,
            epoch_window=[-2.0, 3.0],
        ...
        cross_validation=CrossValidationMetadata(
            cv_method="10 times 5-fold cross-validation",
            cv_folds=5,
            evaluation_type=["within_subject"],
        ),
        performance=PerformanceMetadata(
            accuracy_percent=61.3,
            itr_bits_per_min=None,
            auc=None,
            kappa=None,
            other_metrics={"std": 8.6},
        ),
        bci_application=BCIApplicationMetadata(
            applications=[
                "grasp neuroprosthesis",
    ...
    **Data Organization**
    ...
    METADATA = DatasetMetadata(
        ...
        experiment=ExperimentMetadata(
            ...
            task_type="binary decision",
            events={"green_cross_yes": 1, "red_cross_no": 2},
            n_classes=2,
            class_labels=["yes", "no"],
            trial_duration=None,
            feedback_type="visual (yes/no text)",
            stimulus_type="colored crosses (green + and red x)",
            stimulus_modalities=["visual"],
            primary_modality="visual",
            ...
            stimulus_presentation={
                "duration_ms": "250",
                "soa_ms": "850 (jittered by 0-250 ms)",
                "stimuli_per_trial": "10",
            },
        ),
        documentation=DocumentationMetadata(
            ...
            license=None,
            publication_year=2020,
            senior_author="Stefan Dürschmid",
            contact_info=["christoph.reichert@lin-magdeburg.de"],
            associated_paper_doi="10.3389/fnins.2020.591777",
            funding=[
                "German Ministry of Education and Research (BMBF) within the Research Campus STIMULATE under grant number 13GW0095D"
            ],
            institution_address="Magdeburg, Germany",
            institution_department="Department of Behavioral Neurology",
            ethics_approval=[
        ...
        preprocessing=PreprocessingMetadata(
            ...
            preprocessing_applied=False,
            preprocessing_steps=[
                "re-referenced to average of left and right mastoid",
                "4th order zero-phase IIR Butterworth bandpass filter (1.0-12.5 Hz)",
                "resampled to 50 Hz",
                "epoched from stimulus onset to 750 ms after",
            ],
            filter_details=FilterDetails(
                highpass_hz=1.0,
                lowpass_hz=12.5,
            ...
            re_reference="average of left and right mastoid",
            downsampled_to_hz=50.0,
            epoch_window=[0.0, 0.75],
        ),
        signal_processing=SignalProcessingMetadata(
            classifiers=["Canonical Correlation Analysis (CCA)"],
            feature_extraction=["N2pc", "ERP", "Canonical difference waves"],
            frequency_bands=None,
            spatial_filters=["CCA spatial filters"],
        ),
        cross_validation=CrossValidationMetadata(
            cv_method="leave-one-out cross-validation (LOOCV)",
            cv_folds=None,
            evaluation_type=["within_subject"],
        ),
        performance=PerformanceMetadata(
            accuracy_percent=88.5,
            itr_bits_per_min=3.02,
            other_metrics={
                "std_accuracy": 7.8,
                "min_accuracy": 70.8,
                "max_accuracy": 90.3,
