...
class Nakanishi2015(BaseDataset):
    ...
    def __init__(self):
        super().__init__(
            ...
            events={'9.25': 1, '11.25': 2, '13.25': 3, '9.75': 4, '11.75': 5,
                    '13.75': 6, '10.25': 7, '12.25': 8, '14.25': 9,
                    '10.75': 10, '12.75': 11, '14.75': 12},
    ...
    def data_path(self, subject, path=None, force_update=False,
        ...
        return dl.data_path(url, 'NAKANISHI', path, force_update, update_path,
                            verbose)
